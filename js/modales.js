const infoModal = [
   ...
   },
   {
    ...
    text4: "Las prótesis totales buscan reemplazar la totalidad de los dientes perdidos en una arcada o ambas, evitando así la pérdida acelerada de hueso y devolviendo al tiempo estética y función al paciente.",
   },
   {
    id: 7,
    title: "Ortodoncia",
   ...
   },
   {
    ...
    img: "images/maxilar.png",
    info: "La ortopedia maxilar es la ciencia que se encarga del tratamiento y prevención de los desórdenes óseos y funcionales de los maxilares en pacientes en crecimiento",
    text: "Consiste en corregir irregularidades en los dientes de los niños cuando aún se encuentran en etapa de crecimiento, puesto que una vez terminada dicha etapa ya no se puede hacer uso de esta especialidad. Algunos beneficios:",
     text2: "Corrige mordidas profundas",
     text3: "Permite redirigir el crecimiento de los huesos maxilares",
     text4: "Sitúa en una posición correcta la mandíbula del niño"
   },
   {
    id: 9,
